...
func Benchmark__Linear_FAST_DAM__Set__(b *testing.B) {
	dam_map := dam.New(
		uint64(b.N), dam.With_Performance_Profile[uint64, uint64](dam.PERFORMANCE_PROFILE__FAST),
	)
	b.ResetTimer()
...
func Benchmark__Linear_NORMAL_DAM__Set__(b *testing.B) {
	dam_map := dam.New(
...
func Benchmark__Linear_NORMAL_DAM__Get__(b *testing.B) {
	dam_map := dam.New(
		uint64(b.N), dam.With_Performance_Profile[uint64, uint64](dam.PERFORMANCE_PROFILE__NORMAL),
	)
...
func Benchmark__Random_NORMAL_DAM__Set__(b *testing.B) {
	dam_map := dam.New(
		uint64(b.N), dam.With_Performance_Profile[uint64, uint64](dam.PERFORMANCE_PROFILE__NORMAL),
	)
	keys := generate_random_keys(b.N)
...
func Benchmark__Random_NORMAL_DAM__Get__(b *testing.B) {
	dam_map := dam.New(
		uint64(b.N), dam.With_Performance_Profile[uint64, uint64](dam.PERFORMANCE_PROFILE__NORMAL),
	)
...
func Benchmark__Linear_SAVE_MEMORY_DAM__Set__(b *testing.B) {
	dam_map := dam.New(
		uint64(b.N), dam.With_Performance_Profile[uint64, uint64](dam.PERFORMANCE_PROFILE__SAVE_MEMORY),
	)
	b.ResetTimer()
	for i := uint64(0); i < uint64(b.N); i++ {
		dam_map.Set(i+1, i)
...
func Benchmark__Linear_SAVE_MEMORY_DAM__Get__(b *testing.B) {
	dam_map := dam.New(
		uint64(b.N), dam.With_Performance_Profile[uint64, uint64](dam.PERFORMANCE_PROFILE__SAVE_MEMORY),
	)
...
func Benchmark__Random_SAVE_MEMORY_DAM__Set__(b *testing.B) {
	dam_map := dam.New(
		uint64(b.N), dam.With_Performance_Profile[uint64, uint64](dam.PERFORMANCE_PROFILE__SAVE_MEMORY),
	)
	keys := generate_random_keys(b.N)
...
func Benchmark__Random_SAVE_MEMORY_DAM__Get__(b *testing.B) {
	dam_map := dam.New(
		uint64(b.N), dam.With_Performance_Profile[uint64, uint64](dam.PERFORMANCE_PROFILE__SAVE_MEMORY),
	)
